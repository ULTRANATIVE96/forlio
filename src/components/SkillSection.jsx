...
const skills=[
    ...
    {name:"JDBC", level:100, category:"backend"},
    ...
    return(<scetion 
        ...
        <div className="container mx-auto max-w-5xl">
            <h2 className="text-3xl md:text-4xl font-bold md-12 text-center">
             ...
             <div className="flex flex-wrap justify-center gap-4 mb-12 p-5">
                ...
                {filteredSkills.map((skill,key) =>(
                    ...
                    >
                     <div className="text-left mb-4">
                        ...
                        <div 
                        className="bg-primary h-2 rounded-full origin-left animate[gtoe_1.5s_ease-out]"
                        style={{width:skill.level + "%"}}/>
                        </div>
                        <div className="text-right mt-1">
                            <span className="text-sm text-muted-foreground"
                            >
                                {skill.level}%</span> </div>
                    </div>
                ))}
            </div>
        </div>
